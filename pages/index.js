...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const generatedItinerary = typeof data === 'string' ? JSON.parse(data) : data;
              ...
              <div className="space-y-6">
                {day.activities && day.activities.map((activity, index) => (
                  <div key={index} className="border-l-4 border-blue-500 pl-4 py-2">
                    ...
                    {activity.bookingNeeded && activity.bookingUrl && (
                      <a
                ...
                {day.meals && day.meals.map((meal, index) => (
                  <div key={index} className="border-l-4 border-green-500 pl-4 py-2">
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      {meal.reservationNeeded && meal.reservationUrl && (
                        <a
                          href={meal.reservationUrl}
                          target="_blank"
                          rel="noopener noreferrer"
